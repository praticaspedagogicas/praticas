...
/* ===== SBL LIMPO DATA HORA E AUTORIA OBRIGATORIA 2026-06-16 =====
   SBL_Teste: Autoria obrigatória sem limpar Data/Hora pré-preenchidas. */
(function(){
  'use strict';
  if(window.__sblTesteAutoriaObrigatoria20260616) return;
  window.__sblTesteAutoriaObrigatoria20260616 = true;
  function q(id){ return document.getElementById(id); }
  function setAutoriaRequired(){ var a=q('autoria'); if(a){ a.setAttribute('required','required'); a.setAttribute('aria-required','true'); } }
  function validateAutoria(ev){
    ...
    if(a && !String(a.value || '').trim()){
      ...
      if(typeof toast==='function') toast(msg,'error',6500); else if(typeof showToast==='function') showToast(msg); else if(typeof mostrarToast==='function') mostrarToast(msg); else alert(msg);
      return false;
    }
  }
  if(document.readyState==='loading') document.addEventListener('DOMContentLoaded', setAutoriaRequired); else setAutoriaRequired();
